...
class ChartColors {
  ...
  //背景颜色
  static const Color bgColor = Colors.transparent; //Color(0xff0D141E);
  static const Color kLineColor = Color(0xff60738E); //Color(0xff4C86CD);
  static Color gridColor = Color(0xff4c5c74).withOpacity(0.3);
  ...
  static const Color realTimeTextBorderColor =
      Color.fromARGB(255, 114, 112, 112);
  static const Color realTimeTextColor = Color(0xffffffff);

  //实时线
  static const Color realTimeLineColor =
      Color(0xff60738E); // Color(0xffffffff);
  static const Color realTimeLongLineColor =
      Color(0xff60738E); // Color(0xff4C86CD);
